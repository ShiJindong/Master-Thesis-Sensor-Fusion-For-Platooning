...
def draw_histogram(data, data_name, color_name):
    ratio_outliers = detect_outliers(data, outlier_threshold=0.5)
...
if __name__ == '__main__':
    ...
    # draw_histogram(data=data_fusion_dx, data_name='Schätzfehler von $\Delta\it{x}_{FusionLK}$', color_name='red')
    ...
    draw_histogram(data=data_fusion_dy, data_name='Schätzfehler von $\Delta\it{y}_{FusionLK}$', color_name='red')
    ...
    # draw_histogram(data=data_fusion_dphi, data_name='Schätzfehler von $\Delta\\varphi_{FusionLK}$', color_name='red')
