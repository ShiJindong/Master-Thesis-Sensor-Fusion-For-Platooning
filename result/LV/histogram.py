...
def draw_histogram(data, data_name, color_name):
    ratio_outliers = detect_outliers(data, outlier_threshold=0.2)
...
if __name__ == '__main__':
    ...
    # draw_histogram(data=data_fusion_dx, data_name='Schätzfehler von $\Delta\it{x}_{FusionLV}$', color_name='red')
    ...
    # draw_histogram(data=data_fusion_dy, data_name='Schätzfehler von $\Delta\it{y}_{FusionLV}$', color_name='red')
    ...
    draw_histogram(data=data_fusion_dphi, data_name='Schätzfehler von $\Delta\\varphi_{FusionLV}$', color_name='red')
    ...
    plt.ylim((-0, 0.5))
    # plt.xlabel('Schätzfehler von $\Delta\it{x}$ [m]',fontsize=14)
