...
if __name__ == '__main__':
    ...
    draw_histogram(data=data_fusion_dx, data_name='Schätzfehler von $\Delta\it{x}_{FusionKV}$', color_name='red')
    ...
    # draw_histogram(data=data_fusion_dy, data_name='Schätzfehler von $\Delta\it{y}_{FusionKV}$', color_name='red')
    ...
    # draw_histogram(data=data_fusion_dphi, data_name='Schätzfehler von $\Delta\\varphi_{FusionKV}$', color_name='red')
